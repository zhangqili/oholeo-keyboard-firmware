...
const uint16_t g_default_keymap[LAYER_NUM][ADVANCED_KEY_NUM + KEY_NUM] = {
    ...
    },
    {
        ...
        KEY_TRANSPARENT,        KEY_TRANSPARENT,KEY_TRANSPARENT,KEY_TRANSPARENT,KEY_TRANSPARENT,KEY_TRANSPARENT,KEY_TRANSPARENT,KEY_TRANSPARENT,KEY_TRANSPARENT,KEY_TRANSPARENT,KEY_TRANSPARENT,    KEY_TRANSPARENT,        KEY_PAGE_UP,            KEY_PRINT_SCREEN,
        KEY_TRANSPARENT,        KEY_TRANSPARENT,KEY_TRANSPARENT,KEY_TRANSPARENT,KEY_TRANSPARENT,FN,             KEY_HOME,       KEY_PAGE_DOWN,  KEY_END,
    }
...
const uint8_t command_advanced_key_mapping[ADVANCED_KEY_NUM] = {15, 14, 13, 12, 44, 43, 37, 63,
